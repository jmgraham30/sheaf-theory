...
\newenvironment{solution}[1][\textbf{Solution}\hspace{.5em}]{#1}{\hfill\qed}
...
\newcommand\PCat{\mathsf{Presh}}
\newcommand\restr{\mathrm{res}}
\newcommand\SCat{\mathsf{Shv}}
...
\DeclareMathOperator\PCok{PCok}
\DeclareMathOperator\PIm{PIm}
\DeclareMathOperator\SCok{SCok}
